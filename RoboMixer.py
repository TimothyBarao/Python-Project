    ...
    def on_draw(self):
        ...
        if self.testForSong(self.song1) != 1:
            if self.testForSong(self.song2) != 1:
                ...
                song1 = "wav/knob.wav"
                song2 = "wav/time.wav"
				'''this is where the list generated by the first row of checkboxes should go, we actually only need one list'''
				'''also, make sure that the list that is constructed is values 0 - 7, not 1 - 8'''
				modValues = [7]
